...
export default function FloatingPhrase({ 
  ...
  // TAMAÑOS VARIADOS - 50% MÁS GRANDES
  const sizes = {
    small: {
      padding: '12px 15px',
      gap: '9px',
      ...
      metaFontSize: 'clamp(9px, 1.05vw, 11px)',
      textFontSize: 'clamp(14px, 1.8vw, 18px)',
      minWidth: 'min(260px, 65vw)',
      maxWidth: 'min(450px, 78vw)',
      fontWeight: 400,
    },
    medium: {
      padding: '18px 23px',
      ...
      metaFontSize: 'clamp(11px, 1.35vw, 14px)',
      textFontSize: 'clamp(18px, 2.25vw, 24px)',
      minWidth: 'min(375px, 75vw)',
    ...
    large: {
      ...
      metaFontSize: 'clamp(12px, 1.5vw, 17px)',
      textFontSize: 'clamp(23px, 2.85vw, 32px)',
      minWidth: 'min(490px, 80vw)',
      maxWidth: 'min(710px, 88vw)',
      fontWeight: 700,
    }
  };
