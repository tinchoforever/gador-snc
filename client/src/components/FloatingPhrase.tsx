...
export default function FloatingPhrase({ 
  ...
  // TAMAÑOS VARIADOS - 50% MÁS GRANDES (otra vez)
  const sizes = {
    small: {
      padding: '18px 23px',
      gap: '14px',
      iconSize: 36,
      iconContainerSize: 57,
      metaFontSize: 'clamp(14px, 1.6vw, 17px)',
      textFontSize: 'clamp(21px, 2.7vw, 27px)',
      minWidth: 'min(390px, 70vw)',
      maxWidth: 'min(675px, 82vw)',
      fontWeight: 400,
    },
    medium: {
      padding: '27px 35px',
      ...
      metaFontSize: 'clamp(17px, 2vw, 21px)',
      textFontSize: 'clamp(27px, 3.4vw, 36px)',
      minWidth: 'min(560px, 78vw)',
      maxWidth: 'min(840px, 88vw)',
      fontWeight: 600,
    },
    large: {
      padding: '36px 48px',
      gap: '27px',
      iconSize: 54,
      iconContainerSize: 86,
      metaFontSize: 'clamp(18px, 2.25vw, 26px)',
      textFontSize: 'clamp(35px, 4.3vw, 48px)',
      minWidth: 'min(735px, 85vw)',
      maxWidth: 'min(1065px, 92vw)',
      fontWeight: 700,
    }
  };
